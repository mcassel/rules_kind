...
some other ruleset that depends on rules_kind, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_kind=$(pwd)/rules_kind"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_kind` on your system will point to this folder.
