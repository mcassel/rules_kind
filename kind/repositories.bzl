...
def _kind_repo_impl(repository_ctx):
    url = "https://github.com/someorg/someproject/releases/download/v{0}/kind-{1}.zip".format(
        repository_ctx.attr.kind_version,
        repository_ctx.attr.platform,
    )
    repository_ctx.download_and_extract(
        url = url,
        integrity = TOOL_VERSIONS[repository_ctx.attr.kind_version][repository_ctx.attr.platform],
    )
...
def kind_register_toolchains(name, register = True, **kwargs):
